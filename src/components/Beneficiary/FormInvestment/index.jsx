...
const FormInvestmentProject = ({ formData, setFormData }) => {
  ...
  useEffect(() => {
    if (locationsData.length > 0) setFormData(prevData => ({ ...prevData, locationId: locationsData[0].id || "" }));
    if (landUsesData.length > 0) setFormData(prevData => ({ ...prevData, landUseId: landUsesData[0].id || "" }));
    if (soilTypesData.length > 0) setFormData(prevData => ({ ...prevData, soilTypeId: soilTypesData[0].id || "" }));
    if (typeCategoriesData.length > 0) setFormData(prevData => ({ ...prevData, typeCategoryId: typeCategoriesData[0].id || "" }));
  }, [locationsData, landUsesData, soilTypesData, typeCategoriesData, setFormData]);
